...
import { CaretDown, Check, CheckCircle, GameController } from 'phosphor-react';
            ...
            <form onSubmit={handleCreateAd} action="" className='mt-8 flex flex-col gap-4'>
              <div className='flex flex-col gap-2'>
                ...
                <Select.Root name='game'>
                    <Select.Trigger className='py-3 px-4 rounded text-sm bg-zinc-900 placeholder:text-zinc-500 inline-flex items-center justify-between'>
                    ...
                    <Select.Portal className='bg-zinc-900 block px-4 py-3 relative rounded text-sm top-10'>
                        <Select.Content>    
                            <Select.Viewport className='flex flex-col gap-3'>
                                {games.map(game => {
                                    return (
                                        <Select.Item key={game.id} value={game.id} className='flex items-center text-white hover:text-gray-500 cursor-pointer'>
                ...
                {/* <select id="game" className='bg-zinc-900 py-3 px-4 rounded text-sm placeholder:text-zinc-500'>
                    <option selected aria-readonly value="">Selecione o game que deseja jogar</option>
                </select> */}
